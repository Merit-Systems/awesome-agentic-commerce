...
- [GenTech Labs](https://gentechlabs.net) — x402-monetized API gateway for AI agents. 16 endpoints across gaming, movies, DeFi, security, and search. Pay per call with USDC on Base, Solana, Avalanche, BNB, and OKX. Python SDK available. ([GitHub](https://github.com/ProtoJay4789/gentech-vault))
