...
- [FixFinderOS](https://fixfinderos.com) - Production agentic-commerce service for repair and property-maintenance intelligence. AI agents can discover the service, receive an HTTP 402 payment requirement, pay $0.05 USDC on Base mainnet, and receive structured maintenance triage without an API subscription or API key. ([Agent Manifest](https://fixfinderos.com/.well-known/agent.json))
