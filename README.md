...
- [AlgoVault](https://algovault.com) - AI trading intelligence with 91.6% verified accuracy across 375,000+ calls: composite BUY/SELL/HOLD verdicts, regime classification, and cross-venue funding analysis across major crypto perps. 1,300+ assets, 11 timeframes. Track record Merkle-verified on Base L2. x402 micropayments (USDC on Base); free tier available. [MCP server](https://api.algovault.com/mcp) available.
