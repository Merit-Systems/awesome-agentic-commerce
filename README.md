...
- [x402 Trust Layer](https://x402trustlayer.xyz) — Trust, security & settlement control plane for agent payments. 68 pay-per-call APIs (guard, KYM, mandates, semantic escrow, ERC-8004 trust score). MCP: `@mimranakb/trust-layer-mcp`.
