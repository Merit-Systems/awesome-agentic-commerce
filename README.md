...
- [Bounty Radar](https://github.com/go165/bounty-radar) - Static GitHub bounty discovery tool for x402/Base/USDC/MRWK opportunities. Scores payout signals, extracts payout-address hints, exports CSV, publishes a daily JSON feed for agents, and includes a zero-dependency shortlist CLI. ([Demo](https://go165.github.io/bounty-radar/))
