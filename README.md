...
### Ecosystem
- [afriref / latamref / asiaref / euroref / usaref / ausref](https://afriref.dev) - Verified government reference data API for agents covering 44 countries across six continent-scoped brands on one engine: policy rates, VAT, minimum wages, CPI, income-tax brackets and public holidays — 308 series, each cited to its official source. Africa 16, Latin America 16, Asia 6, Europe 2, North America 2, Australasia 2, with honest structural nulls where no figure exists (no US federal VAT; Singapore's S$NEER band; Argentina's abolished policy rate). From $0.005 USDC per call via x402 on Base (CDP-facilitated); OpenAPI + Bazaar discovery, HMAC-signed change webhooks; computed answers (VAT, minimum-wage compliance, working days, income tax, payroll) and cross-border VAT determination for digital-services sellers (EU/UK/South Africa). ([x402scan](https://x402scan.com/server/5f5e63dc-454c-424f-8ce2-24335e406136))
