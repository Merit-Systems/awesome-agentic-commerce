...
- [x402 API Catalog](https://x402-api-catalog.onrender.com) – Four real x402 checks on Base: npm package trust/risk score (registry age, downloads, GitHub org/stars, OSV.dev vulnerabilities, $0.02), GitHub repo health ($0.02), domain liveness ($0.02), and an x402 service doctor that audits another x402 endpoint for why aggregators mark it "down" and returns a concrete fix ($1.00). No API key, no signup. [Repo](https://github.com/hkaaki/x402-api-catalog)
