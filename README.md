...
- [Viridis Agent Fleet](https://mcp.viridisconservation.com/quickstart) - Eight live x402-paid agent APIs on Base USDC for climate compliance and agent infrastructure: regulatory monitoring, tax-credit calculations, GHG accounting, quantity takeoff, disclosure compilation, multi-agent solving, and MCP security preflight. Includes a machine-readable [x402 catalog](https://mcp.viridisconservation.com/.well-known/x402), [buyer skill](https://mcp.viridisconservation.com/.well-known/skills/viridis-paid-tools/SKILL.md), and independently hosted [fixture evidence](https://github.com/smartflowproai-lang/x402-endpoint-validator/tree/main/tests/fixtures).
