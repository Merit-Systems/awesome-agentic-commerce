...
- [PulseFeed](https://pulsefeed.dev/status) - Independent measurement of x402 payment endpoints: check an endpoint before paying it (live figure for the dead share at pulsefeed.dev/status.json) — liveness, reputation, scam/anomaly scan, on-chain receiver check. Also a live ecosystem observatory, a daily "State of x402" report, a [Security Disclosures](https://pulsefeed.dev/incidents) feed (real threats — receiver hijacks, bait-and-switch, honeypots — each with on-chain proof), and a cross-domain [Data API](https://pulsefeed.dev/data) (x402 + MCP trust data in one call). npm: [pulsefeed-x402-guard](https://www.npmjs.com/package/pulsefeed-x402-guard), [pulsefeed-x402-ai-tools](https://www.npmjs.com/package/pulsefeed-x402-ai-tools) (Vercel AI SDK + LangChain), [pulsefeed-x402-mcp](https://www.npmjs.com/package/pulsefeed-x402-mcp).
