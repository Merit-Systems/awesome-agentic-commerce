...
- [IBANforge](https://ibanforge.com) - Pre-payout counterparty screening for AI agents: IBAN validation, OFAC/EU/UN sanctions screening, Swiss BC-Nummer clearing, SEPA Instant / VoP reachability and risk score. MCP-native ([npm](https://www.npmjs.com/package/ibanforge-mcp), Streamable HTTP at api.ibanforge.com/mcp). Free tier 200 req/month, x402 USDC pay-per-call on Base beyond.
