...
- - [WickedAPI x402 Paywall](https://paywall.wickedapi.com) - Multi-tenant paywall-as-a-service: point at any HTTP backend, set price/network/payout wallet via a REST API, get a live x402 endpoint in one call. Base mainnet, Coinbase CDP facilitator, self-serve signup, live pricing/backend edits with no redeploy. [OpenAPI spec](https://paywall-admin.wickedapi.com/openapi.json).
