...
- [AetherIntel](https://github.com/markoskarllos-netizen/aetherintel-marketplace) - ERC-8004 agent reputation auditor across 10 EVM chains and generic wallet due-diligence, paid via x402 on Base mainnet. Free MCP tools (OFAC sanctions screening on real Treasury SDN data, text summarization); paid endpoints for full audits and adversarial code verification with real execution.
