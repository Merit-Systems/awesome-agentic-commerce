...
- [GoldBean](https://github.com/wuzenghai616-lang/goldbean) — x402 micropaid API marketplace with 12 endpoints covering blockchain data (BTC, ETH, gas, DeFi TVL, MEV reports). MCP-compatible, discoverable via AgentCash. Running on Base (`0xB5f5CBe48E0595C044Bc626f278F757463eAc2Ce`).
