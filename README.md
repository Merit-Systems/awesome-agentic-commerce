...
- [RepoPulse](https://repo-pulse.dvd90.workers.dev) - Pay-per-call GitHub repo health scores ($0.01 USDC on Base); deterministic nine-signal scoring, Bazaar-discoverable, bundled MCP server.
- [Beef402](https://beef402.dvd90.workers.dev) - Pay-per-battle AI roast arena ($0.05 USDC on Solana/SVM); includes an ADR on implementing the x402 exact scheme on SVM.
