...
- [jurat](https://jurat.dev) - Evidence infrastructure for AI agents: notarized snapshots of any URL, sports finals with proof attached, and watchers/wakeups for ephemeral agents. Pay-per-call USDC on Base via x402, no signup. ([OpenAPI](https://jurat.dev/openapi.json)) ([llms.txt](https://jurat.dev/llms.txt))
