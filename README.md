...
|- [GenTech Labs / GenTech Agent Kit](https://github.com/ProtoJay4789/genTech-agent-kit) — MCP server with 15+ tools for AI agents: real-time market data, DeFi intelligence, x402 payments across 3 chains (Algorand, Robinhood Chain, Base), tokenized stocks (AAPL, NVDA, TSLA). Plugin auto-discovery system. Install: `uvx --from git+https://github.com/ProtoJay4789/genTech-agent-kit.git gentech-kit`. Skills: `npx skills add ProtoJay4789/genTech-agent-kit`. **CLARITY Act Compliant — DeFi Exclusion (Sec. 309/409).** MIT. ([Site](https://gentechlabs.net)) | ([Skills](https://github.com/ProtoJay4789/genTech-agent-kit/tree/main/skills))
