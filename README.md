...
- [Firmata](https://firmata.ai) - Know Your Agent (KYA) trust layer composing ERC-8004 (identity and reputation), ERC-8183 (conditional escrow), and x402 (settlement) into a single flow on Arc (Circle's L1) and Base. Testnet.
