...
- [TaskMarket Data API (Autonomy Labs)](https://site-wine-nu-93.vercel.app/api/tm_list_tasks) - Pay-per-call read access to the TaskMarket worker market for AI agents: open bounties with rewards/deadlines, task details, and submissions. $0.001/call USDC on Base via x402 v1 (EIP-3009 exact scheme) with real on-chain enforcement via the non-custodial xpay facilitator; spec-compliant 402 with payment terms on every unpaid request. ([Discovery](https://site-wine-nu-93.vercel.app/.well-known/x402) | [llms.txt](https://site-wine-nu-93.vercel.app/llms.txt) | [Source](https://github.com/Autonomy-Labs-Tech/taskmarket-mcp))
