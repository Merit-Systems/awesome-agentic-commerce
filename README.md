...
- [relay402](https://relay402.georgespring.workers.dev) - Pay-per-call structured data APIs for AI agents on Base. Amazon product data as schema-validated JSON at $0.01 USDC via x402 v2, machine-readable catalog at [/index.json](https://relay402.georgespring.workers.dev/index.json).
