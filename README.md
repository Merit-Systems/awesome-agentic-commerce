...
- [Paywright](https://paywright.xyz) - The Postman for x402. Browser tool that runs the full flow against any endpoint: probe the 402, decode payment requirements, pay in USDC (client-side EIP-3009 signing), inspect the settled response and on-chain receipt. ([GitHub](https://github.com/web3xDev/402paywright)) AGPL-3.0.
