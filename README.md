...
- [Cook County Property Records API](https://api.ingest0r.com/) - Pay-per-call Cook County / Chicago property data for agents: free address-to-PIN search, parcel records, full property dossiers (sales, permits, assessments), and comparable-sales valuation via x402 (USDC on Base/Solana); A2A/MCP/llms.txt discovery surfaces and free live sample parcels.
