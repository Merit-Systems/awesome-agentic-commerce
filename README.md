...
- [VulnFeed MCP](https://vulnfeed.novadyne.ai) - Dependency vulnerability scanner with EPSS scoring for AI agents. 9 MCP tools, x402 micropayments. Free tier available. ([GitHub](https://github.com/novadyne-hq/vulnfeed-mcp))
- [Ledger API](https://ledger-api.novadyne.ai) - Double-entry ledger with Ed25519 capability tokens and x402 micropayments.
