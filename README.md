...
- [The Stall](https://the-stall.intuitek.ai) - 209 pay-per-call market data capabilities for AI agents via MCP and x402. US/EU/AU/JP/KR equities, crypto/DeFi (Polymarket, DeFiLlama, DEX quotes), global news (GDELT), SEC/EDGAR filings, congressional trades, insider activity, weather/climate history, and options flow (GEX via CBOE). USDC on Base, $0.001–$0.65/call. No API keys required.
