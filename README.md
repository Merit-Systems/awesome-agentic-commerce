...
- [The Stall](https://the-stall.intuitek.ai) - 201 pay-per-call data capabilities via x402 on Base mainnet: financial markets (US/intl equities, options, ETFs), DeFi analytics, crypto intelligence, social signals, compliance tools, and more. USDC per call via Coinbase CDP facilitator. MCP-compatible. ([Agent Card](https://the-stall.intuitek.ai/.well-known/agent.json))
