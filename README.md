...
- [botwire-mcp](https://github.com/ArasPasha/botwire-mcp) - MCP server for [The Bot Wire](https://thebotwire.com), 301 real-time data wires read from primary sources: SEC EDGAR, the Federal Reserve and ECB, BLS/BEA, federal court opinions, congressional bills, DOJ, FDA, CISA advisories and CVEs, USGS earthquakes, NWS severe weather, arXiv, NASA, EIA energy and federal contract awards, plus news and trade press. Each wire advertises the question that should trigger it, so an agent routes without guessing. Paid per call at $0.005-$0.01 USDC on Base via x402 v2 (CDP facilitator), no API key. All 301 routes indexed in the Coinbase Bazaar. Install: `npx -y botwire-mcp`. ([npm](https://www.npmjs.com/package/botwire-mcp) | [MCP Registry](https://registry.modelcontextprotocol.io/v0/servers?search=botwire))
