...
- [GPT-5.5 x402 Gateway](https://github.com/go165/gpt55-x402-gateway) - OpenAI-compatible GPT-5.5 chat and MCP tools served behind x402 Base USDC payments, with public discovery metadata and live endpoints at `gpt55.558686.xyz`.
