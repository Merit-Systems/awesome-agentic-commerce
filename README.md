...
- [DeskCrew](https://deskcrew.io/agents) - Agent-callable support desk over MCP: tickets, knowledge base search and grounded reply drafts, paid per call in USDC on Base, Polygon, Sei and Solana. No account or API key.
