...
- [base-gas-x402](https://github.com/memosr/base-gas-x402) – Pay-per-call Base mainnet gas oracle for agents. Live EIP-1559 base fee and priority tiers, cost estimates for any gas limit, cross-chain comparison (Base / OP Mainnet / Arbitrum / Ethereum), historical trend with a cheap-normal-expensive verdict, and an hour-of-day cheapest-window ranking. USDC on Base via the CDP facilitator, $0.005–$0.02 per call, free `/health` route publishing history coverage. [Live](https://base-gas-x402-production.up.railway.app) · [MCP server](https://www.npmjs.com/package/base-gas-mcp)
