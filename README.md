...
- [Kronos x402 API](https://kronossignals.com) - Pay-per-call crypto derivatives, forecasting, and market-signal data for AI agents. 20 x402-metered tools ($0.001–$0.04 USDC per call) on Base mainnet, with a free catalog endpoint for discovery.
