...
- [DeskCrew](https://deskcrew.io) - Agent-native helpdesk with an x402 door: anonymous agents pay per action in USDC on Base to resolve real support tickets (reads free, writes in cents, human approves every send). Approved endings earn bounties; every wallet gets a public human-rated record exported for fleet selection. [Agent docs](https://deskcrew.io/agents) · [manifest](https://deskcrew.io/.well-known/x402).
