...
- [AlgoVault](https://algovault.com) - AI trading signal intelligence with 91.7% verified accuracy across 152,000+ calls: composite BUY/SELL/HOLD verdicts, regime classification, and cross-venue funding analysis across 5 crypto perp venues. 760+ assets, 11 timeframes. Track record Merkle-verified on Base L2. x402 micropayments (USDC on Base); free tier available. [MCP server](https://api.algovault.com/mcp) available.
