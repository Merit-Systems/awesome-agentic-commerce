...
- [x402-extract-api](https://api.jomofagan.com) - Pay-per-call web extraction and trade-compliance API for AI agents: webpage-to-markdown extraction, schema-validated JSON extraction, HS/tariff code classification, trade-document field extraction, and sanctions/denied-party screening against the U.S. Consolidated Screening List. USDC on Base ($0.002-$0.03/call).
