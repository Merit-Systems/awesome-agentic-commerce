...
- [Bug Bounty Intelligence](https://github.com/holistis/bug-bounty-intelligence-mcp) - Smart contract security scanner for AI agents, x402 pay-per-scan ($5 USDC on Base). Trained on 27,681 real accepted findings from Sherlock and Code4rena, MCP server included, reports within 24h.
