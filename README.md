...
- [relay402](https://relay402.georgespring.workers.dev) - Pay-per-call verification and data APIs for AI agents on Base: package vulnerability checks, npm risk signals, OFAC sanctions screening, robots.txt crawl permission, Wayback snapshots, Amazon product data, barcode lookup, and more. $0.005-$0.10 USDC via x402 v2, schema-validated JSON, free demo on every endpoint. ([Catalog](https://relay402.georgespring.workers.dev/index.json) | [OpenAPI](https://relay402.georgespring.workers.dev/openapi.json) | [Discovery](https://relay402.georgespring.workers.dev/.well-known/x402.json))
