...
- [SchemaLock](https://doc-extract-api.thestarboy9696-4ef.workers.dev) - Structured JSON extraction from invoices, receipts, contracts, resumes, or any raw PDF/image/text via a caller-supplied JSON Schema. Financially-validated output (line items checked against totals), not just raw OCR text. $0.05-$0.08/call, USDC on Base. [MCP server](https://www.npmjs.com/package/doc-extract-api) available ([GitHub](https://github.com/thestarboy9696/doc-extract-api)).
