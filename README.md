...
- [Link Preview API](https://link-preview-api-z4nf.onrender.com) - Fetch Open Graph / meta metadata (title, description, image, favicon, canonical URL) for any public URL. $0.01 USDC per call on Base mainnet via Coinbase CDP facilitator.
