...
- [Starchild Relay](https://community.iamstarchild.com/5108-data-api-proxy/) — Multi-source data proxy giving agents access to 17 official APIs through a single x402 endpoint: CoinGecko, CoinGlass, Twelve Data, Massive (US options), TAAPI, LunarCrush, DefiLlama, Birdeye, DeBank, 1inch, Brave Search, Twitter/X, Apify, Firecrawl, ScrapeCreators, Google Maps, and Tushare. Covers crypto spot and derivatives, US stocks/forex/commodities, options chains, DeFi/onchain analytics, technical indicators, social sentiment, web search and scraping, and China A-shares. No API keys required. Prepaid model, from $0.0002/call on Base, Monad, and Robinhood Chain (eip155:8453 / eip155:143 / eip155:4663).
