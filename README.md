...
- [Oblique Markets](https://oblique.markets) - 59 pay-per-call HTTP APIs for AI agents, no accounts or API keys; each 402 accepts x402 (USDC on Base and Solana) and MPP/Tempo. Catalog at [`/.well-known/x402.json`](https://oblique.markets/.well-known/x402.json), [OpenAPI](https://oblique.markets/openapi.json), [MCP](https://api.oblique.markets/mcp), [examples](https://github.com/oblique-markets/oblique-examples) and an open-source [MCP bridge](https://github.com/oblique-markets/mcp-server).
- [remote.observer](https://remote.observer) - Free public observatory of the x402 Bazaar: daily full-catalog snapshots since July 2026, market telemetry (listing churn, survival, crawler traffic) and a pre-registered hypothesis ledger scored by code. Free MCP at `https://remote.observer/mcp`; JSON feeds at [`/experiment.json`](https://remote.observer/experiment.json) and [`/market-live.json`](https://remote.observer/market-live.json).
