...
- [Open Source Filings (OSF)](https://osf-master-server.com) - Pay per record marketplace of provenance stamped US public data for agents: 7.2M records across 80 sources including sanctions and exclusion screening (eleven lists, ten authorities), 1.5M court opinions, SEC filings, exploited CVE checks, FDA recalls, and research. 18 priced x402 endpoints on Base in USDC plus a 20 tool MCP server. $0.001 per record on the sample tier, $0.05 per search call.
