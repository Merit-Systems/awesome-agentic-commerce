...
- [Vaaya](https://vaaya.ai) - Agent payment system MCP server: agents buy media/video generation, product demo rendering, web search & scraping, deep research, lead enrichment, code sandboxes, and browser automation pay-per-call via x402 (USDC on Base) or Stripe MPP — no API keys.
