...
- [AgentLayer](https://github.com/lopushok9/Agent-Layer) - Beta local-first wallet for AI agents with x402 payments and DeFi operations. It previews payment terms and executes approved Solana buyer-side x402 requests; EVM x402 is prepare-only.
