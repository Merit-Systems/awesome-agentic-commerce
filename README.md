...
### Ecosystem
- [Amora Protocol — x402 Dual-Gateway](https://x402-dual-gateway.andeglenderson.workers.dev) — Zero-database dual-gateway on Cloudflare Workers. C2PA Trust Oracle (/verify) + Economic Notary (/stamp). Settles in USDC on Base.
