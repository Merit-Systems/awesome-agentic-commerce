...
- [x402-endpoints](https://x402-endpoints.onrender.com) - 28 paid data tools for AI agents: official EU/global registries (GLEIF LEI, EU VIES VAT, BODACC, EUR-Lex, UK Companies House, EPO patents, EU sanctions screening, CVE/NVD, FDA recalls/labels) plus crypto pre-trade signals (token safety/honeypot, perp funding & OI radar, wallet x-ray with OFAC screening, DEX-CEX arbitrage spread, new DEX pairs). $0.01–$0.05 USDC on Base, no signup — the wallet is the auth. On the official MCP registry. ([x402.json](https://x402-endpoints.onrender.com/.well-known/x402.json) | [MCP](https://x402-endpoints.onrender.com/mcp/) | [GitHub](https://github.com/digitalweb33333-creator/x402-endpoints))
