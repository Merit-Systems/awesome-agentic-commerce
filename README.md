...
- [Suede AI](https://app.suedeai.ai) - 24 paid AI skills for music generation, video, IP rights lookup, and audio analysis (stems, MIDI, mastering, lyric sync, vocal isolation). USDC on Base. Multi-protocol: Stripe ACP, Virtuals ACP, and x402 discovery via [/.well-known/agentic-commerce.json](https://app.suedeai.ai/.well-known/agentic-commerce.json), [/.well-known/x402.json](https://app.suedeai.ai/.well-known/x402.json), [/.well-known/virtuals-acp.json](https://app.suedeai.ai/.well-known/virtuals-acp.json), [/.well-known/agent-card.json](https://app.suedeai.ai/.well-known/agent-card.json), and [/api/v1/catalog](https://app.suedeai.ai/api/v1/catalog).
