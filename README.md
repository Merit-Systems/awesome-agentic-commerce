...
- [x402 List](https://x402-list.com/) - Agent-first directory of x402 API services with on-chain-verified settlement volume per facilitator (single-leg, counted only when volume > 0), live uptime monitoring, a machine-readable JSON API, an MCP server, and llms.txt for agent discovery.
