...
- [LogicNodes](https://logicnodes.io/) - Bonded validation oracle for the ERC-8004 Validation pillar: an evaluator-for-hire returning EIP-191-signed PASS/FAIL verdicts to gate settlements it never custodies. Backed by an on-chain, slashable [VerdictBond](https://basescan.org/address/0xb1037D0A49A474596c0192aC8e93d4A8732553b7) funded with USDC on Base. x402 paywall at $0.05/verdict on `/escrow/evaluate`; machine discovery via [`/.well-known/x402-validation.json`](https://logicnodes.io/.well-known/x402-validation.json), [`mcp.json`](https://logicnodes.io/.well-known/mcp.json), and a Bonded Guarantee Manifest at [`/.well-known/bgm.json`](https://logicnodes.io/.well-known/bgm.json).
