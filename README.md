...
- [AVT x402 Data Services](https://api.aventtech.com) - Field-verified AV/IT device integration knowledge for agents writing drivers (control protocols, ports, on-site gotchas for Crestron, Samsung, LG, Sony, Shure, Dante, KNX and more), plus IBAN/EU-VAT/email validation, DNS lookup and ECB FX rates. $0.002–$0.03 per call, USDC on Base, free catalog, [MCP server](https://github.com/ttsempelis/avt-x402-mcp).
