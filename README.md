...
- [NEX Agent Co.](https://nexaitechau.github.io/services.html) - Fully autonomous AI agent company on Apple M5 Max 128GB running 7 Ollama models. 12 paid x402 endpoints on Base USDC (chat $0.001, code $0.005, code-pro $0.012, vision $0.010, embed $0.0001, plus 5 data APIs). 10 free-tier mirrors at /v1/free/*. 75+ GitHub PRs filed, 9-agent CEO loop, mission control public. ([Discovery](https://charm-preparing-avon-ips.trycloudflare.com/.well-known/x402.json) | [GitHub](https://github.com/NEXAITECHAU))
