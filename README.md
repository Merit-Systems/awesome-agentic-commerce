...
- [GPT55 x402 Gateway](https://gpt55.558686.xyz/x402/service) - OpenAI-compatible GPT-5.5 and MCP gateway for x402-paid agent tools on Base USDC, with public service JSON, OpenAPI, tools catalog, and MCP server metadata for agent discovery. ([x402 discovery](https://gpt55.558686.xyz/.well-known/x402), [MCP server card](https://gpt55.558686.xyz/.well-known/mcp/server-card.json), [OpenAPI](https://gpt55.558686.xyz/openapi.json), [GitHub](https://github.com/go165/gpt55-x402-gateway))
