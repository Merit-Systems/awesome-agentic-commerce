...
- [relay402](https://relay402.georgespring.workers.dev) - Pay-per-call structured data APIs for AI agents on Base: Amazon product data, Greenhouse job openings, and OFAC sanctions screening. $0.01-$0.10 USDC via x402 v2, schema-validated JSON, catalog at [/index.json](https://relay402.georgespring.workers.dev/index.json).
