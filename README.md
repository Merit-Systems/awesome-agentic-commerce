...
- [agent-tools-mcp](https://github.com/JoursBleu/agent-tools-mcp) - Discovery-layer MCP for x402 paid services. Indexes 2,300+ services from public x402 indexes with quality signals (confidence + 30-day on-chain transaction volume). Free remote (streamable-http) endpoint at https://agent-tools.cloud/mcp-discovery/. ([PyPI](https://pypi.org/project/agent-tools-mcp/), [MCP Registry](https://registry.modelcontextprotocol.io/v0/servers?search=agent-tools-mcp))
