...
- [elsas.it](https://elsas.it) - Daily security intelligence reports for AI agent stack operators, sold per-request for $0.10 USDC via x402 with a self-hosted facilitator on Base. Free sample report available via MCP without payment.
