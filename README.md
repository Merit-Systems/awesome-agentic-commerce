...
- [Vealth](https://vealth.net) - The program of programs for provisioning ecological wealth. x402 endpoints for the full lifecycle of ecological and health work — a work packet (place + problem → a bounded, fundable, provable job), proof verification, tCO2e accounting, and on-chain settlement attestation — plus mission scorecards (LBC / Michelin / SDG) and Klima carbon retirement. USDC on Base via EIP-3009. Discovery at [/.well-known/x402](https://vealth.net/.well-known/x402), agent guide at [/llms.txt](https://vealth.net/llms.txt).
