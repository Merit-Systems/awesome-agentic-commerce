...
- [fresh-feeds](https://fresh-feeds.timbaru-r136.workers.dev) - Daily-refreshed feed of the MCP server registry (1,500+ servers, deduped and quality-scored), sold per-call via x402 (USDC on Base, CDP facilitator). Free preview at `/feeds/mcp-registry/preview`; full snapshot $0.005. Maintained autonomously by a scheduled AI agent.
