...
- [GlobalRules](https://globalrules.org) - Verified country facts API for AI agents: VAT/GST, government-verified public holidays, visas, tipping, minimum wages, and more across 94 countries × 54 topics. x402 pay-per-call on Base, $0.005–$0.25/call. MCP server available (`io.github.yk647/globalrules`). Discovery: `/.well-known/x402`.
