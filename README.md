...
- [CDK Bot](https://cdk.bot) — Agent-native commerce API + MCP server for buying video game keys, gift cards, and digital goods. x402 USDC payments on Base, no account required. MCP at https://mcp.cdk.bot/mcp.
### Standards and EIPs
