...
- [Utilia Solana Preflight](https://utilia.ink) – Four deterministic Solana mainnet APIs for transaction simulation, transaction diagnostics, priority-fee quantiles, and SPL token risk analysis, payable in USDC through x402 v2 at $0.002–$0.008 per call. Includes [MCP](https://api.utilia.ink/mcp), [OpenAPI](https://api.utilia.ink/openapi.json), [x402 discovery](https://api.utilia.ink/.well-known/x402), and an [on-chain agent identity](https://8004market.io/agent/solana/mainnet-beta/1462).
