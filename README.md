...
- [BaseLens](https://github.com/YoungAlgy/baselens) - Pay-per-call AI agent that reads any Base address and returns a structured risk/activity report, priced in USDC over x402. Built with Coinbase's CDP SDK and Anthropic's API.
