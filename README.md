...
- [Secant Agent Research Pack](https://agentic.secantoutreach.com/agent-research) - MCP-first paid web research API for autonomous agents. Publishes x402 discovery, OpenAPI, an agent card, and a remote MCP endpoint; payments settle in Base USDC per request.
