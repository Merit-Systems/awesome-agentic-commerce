...
- - [LEGIT](https://legit.gonna.bond) - Trust scores and organic demand intelligence for x402 agents: measured merchant behavior across 20 chains, a free leaderboard, and per-call USDC verdicts on Algorand or Base. MCP: https://legit.gonna.bond/mcp (streamable-http). Created by GONNA.
