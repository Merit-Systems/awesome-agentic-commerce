...
- [InboxPolicy](https://inboxpolicy.com/x402-email-verification) - Send-decision email verification API for AI agents: keyless x402 payments on Base USDC ($0.01/call), OpenAPI discovery at https://api.inboxpolicy.com/openapi.json, MCP server, batch x402 up to 5,000 emails, and free 72h re-verification cache.
