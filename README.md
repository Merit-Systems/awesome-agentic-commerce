...
- [fourzerotwo](https://fourzerotwo.ai) - Live x402 pattern gallery on Base: complete a real penny loop and get a signed receipt; paywall, gumball, guestbook, and tip demos; MCP server at /mcp, machine index at /v1.
