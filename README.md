...
- [AI Work Market — 6 x402 Data APIs](https://ai-work-market.ai) - Six x402-paid APIs for AI agents on Base Mainnet (USDC): crypto prices (CoinGecko, $0.005), web search (DuckDuckGo, $0.01), news + summary (RSS, $0.02), and three AWM-specific endpoints — work contract lookup ($0.001), agent reputation ($0.005), and a work contract verifier that returns a release/dispute/wait decision ($0.01). Direct on-chain payment verification (no third-party facilitator). [Manifest](https://ai-work-market.ai/.well-known/x402-manifest.json) [Dashboard](https://ai-work-market.ai/dashboard) [GitHub](https://github.com/darioandyoshi-tech/awm-skills)
