...
- [NumProof](https://numproof.com) - Deterministic, signed verification of numeric & financial claims for AI agents and spreadsheets. Returns VERIFY/REFUTE/ABSTAIN with provenance and a signed receipt anyone can re-check offline (open MIT client). x402-paid endpoints on Base (USDC); MCP at `https://numproof.com/mcp.json`. ([GitHub](https://github.com/projecttron/numproof), [Docs](https://numproof.com/docs))
