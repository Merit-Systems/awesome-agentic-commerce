...
- [Bounty Radar](https://github.com/go165/bounty-radar) - Static GitHub bounty discovery tool for x402/Base/USDC/MRWK opportunities. Scores payout signals, publishes JSON/CSV feeds with opportunity classes and effort scores for agents, extracts payout-address hints, exports CSV, and includes a zero-dependency shortlist CLI. ([Demo](https://go165.github.io/bounty-radar/))
...
- [x402 Paid API Starter](https://github.com/go165/x402-paid-api-starter) - Zero-dependency Node.js starter for a free preview route, 402-style paid route, `.well-known/x402` discovery, OpenAPI output, local tests, Cloudflare Worker example, and Express production integration path.
