...
- - [AlphaPipeline](https://alphapipeline-eu.onrender.com) - x402-gated crypto data API for AI trading agents: Korea/global price premium alerts, on-chain token-unlock risk scoring, GoPlus/Honeypot.is token security scans, Bybit funding rates, and an AI-ready webpage-to-Markdown converter - $0.005-$0.03 USDC per call on Base.
