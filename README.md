...
- [Groundcheck](https://groundcheck.seiche.info) - Claim grounding and delivery attestation for AI agents. Sends back machine-verified verdicts with confidence scores and cited sources; signed offline-verifiable receipts bind an x402 payment to what was actually delivered. Free single-claim tier, paid endpoints from $0.005 in USDC on Base via the CDP facilitator. [MCP server](https://www.npmjs.com/package/groundcheck-mcp) available.
