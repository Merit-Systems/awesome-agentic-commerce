...
- [BlockLabs Catalog](https://shop.blocklabs.nl) - x402-payable dropshipping shop: 300,000+ physical products for AI agents and humans, USDC on Base and Solana, EU-only shipping declared in the bazaar schema. Paid typo-tolerant search ($0.001/query), signed offers & receipts, agent-readable [llms.txt](https://shop.blocklabs.nl/llms.txt). [MCP server](https://www.npmjs.com/package/@blocklabs/shop-mcp) available.
