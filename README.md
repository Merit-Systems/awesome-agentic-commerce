...
- [The Stall](https://the-stall.intuitek.ai) — Financial intelligence for autonomous agents. US stock prices, concentration risk scores, and market intelligence, served per-call via x402 USDC on Base. ([Agent card](https://the-stall.intuitek.ai/.well-known/agent.json))
