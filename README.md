...
- [MainStreet](https://avisradar-production.up.railway.app/mainstreet.html) — Reputation oracle for onchain AI agents on Base. Vet any wallet/token before x402 payments. Returns BLOCK/CAUTION/PROCEED in <100ms with EIP-712 signatures. Covers Virtuals agents, Clanker tokens, DEX launches, sniper detection. Free reads + x402-paywalled premium audits (/usr/bin/bash.25 /audit, /usr/bin/bash.50 /risk-report,  /pre-launch-audit,  /angel-enrollment). ERC-8004 registered (agentId 53953). ([Agent Card](https://avisradar-production.up.railway.app/.well-known/agent.json) | [OpenAPI](https://avisradar-production.up.railway.app/api/agent/openapi.json) | [MCP](https://www.npmjs.com/package/@raskhaaa/mainstreet-oracle) | [Skill](https://github.com/philpof102-svg/avisradar/tree/main/skills/mainstreet))
