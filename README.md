...
- [Content Moderation API](https://content-moderation-api-hhy1.onrender.com) - Wordlist-based profanity/explicit-content detection with leetspeak/obfuscation handling. Returns a flag, matched terms, and a redacted version. $0.005 USDC per call on Base mainnet via Coinbase CDP facilitator, no API keys. Also available as an MCP tool.
