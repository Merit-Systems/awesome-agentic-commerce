...
- [DPX Intelligence API](https://intelligence.untitledfinancial.com) - Compliance-grade macro, climate, geopolitical, and market-stress intelligence for AI agents making investment decisions. 29 pay-per-call endpoints (macro stress, sovereign debt, FX settlement risk, supply chain, political risk, and more) on Base mainnet via the Coinbase CDP facilitator.
