...
- [The Bot Wire](https://thebotwire.com) - 57 real-time primary-source data wires for AI agents: SEC EDGAR, Federal Register, federal court opinions, congressional bills, DOJ, FDA, Federal Reserve and ECB, BLS/BEA economic releases, CISA CVEs, NWS alerts, USGS quakes, arXiv, plus Government of Canada, WTO, ReliefWeb, UK court judgments, State Dept travel advisories, IETF/W3C standards and ESA. $0.005-$0.01 USDC on Base via x402 v2 with Bazaar discovery, free 3-result preview on every wire, no API key or signup. MCP at /mcp and `npx botwire-mcp`.
