...
### Ecosystem
- [afriref / latamref / asiaref / euroref / usaref / ausref](https://afriref.dev) - Verified government reference data API for agents covering 58 countries across six continent-scoped brands on one engine: policy rates, VAT, minimum wages, CPI, income-tax brackets and public holidays — 406 series, each cited to its official source. Africa 22, Latin America 16, Asia 10, Europe 6, North America 2, Australasia 2, with honest structural nulls where no figure exists (no US federal VAT; Malaysia levies SST rather than a VAT; no national statutory minimum wage in Italy or Bangladesh; Singapore's S$NEER band; Argentina's abolished policy rate). Shared-rate blocs are reconciled rather than duplicated — the 7 WAEMU members carry one BCEAO rate, the 6 CEMAC members one BEAC TIAO, and the 5 euro-area members one ECB deposit facility rate. From $0.005 USDC per call via x402 on Base (CDP-facilitated); OpenAPI + Bazaar discovery, HMAC-signed change webhooks; computed answers (VAT, minimum-wage compliance, working days, income tax, payroll) and cross-border VAT determination for digital-services sellers (EU/UK/South Africa). ([x402scan](https://x402scan.com/server/5f5e63dc-454c-424f-8ce2-24335e406136))
- [ZARONIA Verify](https://api.zaroniacalculator.co.za) - Independent audit-grade recomputation of South African ZARONIA-linked FRN and money-market coupons against the SARB Compounded ZARONIA Index: full workings, verdict at 0.05bp tolerance, provenance; reproduces BESA/bank acceptance values to 4dp. $0.005–$0.25 USDC via x402 on Base; free conventions and latest-index endpoints.
