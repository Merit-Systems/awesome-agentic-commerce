...
- [Kraken Crypto Signals](https://signals.nsgoods.org) - Pay-per-call crypto market-state signals (BUY/SELL/HOLD + confidence) for AI agents over x402 on Base. ECDSA-signed responses, provable commit-reveal track-record, `/backtest` proof-of-edge, free preview, no API keys. 5 paid endpoints + MCP bridge. ([OpenAPI](https://signals.nsgoods.org/openapi.json) · [x402scan](https://www.x402scan.com/server/bcc5723d-17eb-40f2-9e23-c1f2e3387dd2) · [GitHub](https://github.com/Nikoble1926/kraken-crypto-signals))
