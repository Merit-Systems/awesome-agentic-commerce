...
- [ALFRED](https://x402.wallace.us/.well-known/x402) - Self-hosted personal-assistant paid tools. 21 endpoints across vision + long-context (256k ctx) reasoning on a local RTX 5090, custom SDXL/FLUX character LoRA training, FLUX image generation, Whisper transcription, article/PDF/YouTube extraction, Wikipedia + Hacker News, live WeatherFlow Tempest sensor readings. Dual rail: USDC on Base via Coinbase CDP Facilitator, plus Lightning (BOLT11/BOLT12). All 21 registered on x402scan. Prices $0.02–$100. ([OpenAPI](https://x402.wallace.us/openapi.json) | [Catalog](https://x402.wallace.us/x402/services))
