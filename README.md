...
- [TrustDex Token Risk API](https://trustdex.app/docs/api/) - Machine-payable token-safety intelligence for agents: A+–F risk verdicts across 4 chains, pre-graduation Solana signals, wallet audits, rug/collapse datasets, and provider-risk grades for vetting x402 sellers before paying them. USDC on Solana, Base, Polygon, Arbitrum and Avalanche (x402 v1+v2, charge-on-success); MCP endpoint included.
