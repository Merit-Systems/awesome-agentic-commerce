...
### Ecosystem
- [afriref](https://afriref.dev) - Pan-African government reference data API for agents: central-bank policy rates, VAT, minimum wages, CPI inflation, income-tax brackets and public holidays for 11 African countries (Nigeria, Kenya, Ghana, Tanzania, Uganda, Rwanda, Egypt, Morocco, Côte d'Ivoire, Senegal, Ethiopia), every value cited to its official gazette or central-bank source. From $0.005 USDC per call via x402 on Base (CDP-facilitated); OpenAPI + Bazaar discovery, HMAC-signed change webhooks; computed answers (VAT, minimum-wage compliance, working days, income tax, payroll) and cross-border VAT determination for digital-services sellers (EU/UK/South Africa). ([x402scan](https://x402scan.com/server/5f5e63dc-454c-424f-8ce2-24335e406136))
- [latamref](https://latamref.dev) - Latin American government reference data API for agents: policy rates, VAT, minimum wages, CPI, income-tax brackets and public holidays for 12 countries (Mexico, Brazil, Argentina, Colombia, Chile, Peru, Uruguay, Ecuador, Guatemala, Costa Rica, Dominican Republic, Paraguay), each cited to its official source. Same engine and rails as afriref. From $0.005 USDC per call via x402 on Base.
