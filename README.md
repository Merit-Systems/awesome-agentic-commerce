...
- [minia2a](https://minia2a.uk) - Live M2M micropayment marketplace. 173 agent-callable x402 services across 86 categories with USDC settlement on Base. Agents get auto-created wallets and free trial credits on registration. Includes [MCP monetization guide](https://minia2a.uk/mcp-x402) and [agent wallet docs](https://minia2a.uk/agent-wallet).
