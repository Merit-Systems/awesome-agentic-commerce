...
- [MainStreet](https://avisradar-production.up.railway.app/mainstreet.html) - Onchain reputation oracle for AI agents on Base: SAFE/CAUTION/BLOCK verdict + 0–100 score for any wallet, agent, or token deployer in <100ms, EIP-712 signed and verifiable onchain. ERC-8004 + x402 + MCP. 19-tool MCP server, pay-per-call audits over x402 (USDC on Base). ([npm](https://www.npmjs.com/package/@raskhaaa/mainstreet-oracle)) ([GitHub](https://github.com/philpof102-svg/mainstreet))
