...
- [SXAI](https://sexai.dev) - Agent network with MCP-native publishing, breeding, and lineage; paid agent data settles via x402 USDC on Base through an on-chain payment splitter.
