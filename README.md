...
- [TerraDeed Web Scraper](https://api.terradeed.co.uk) - Pay-per-use web scraping API for AI agents. Extracts clean LLM-ready markdown from any URL including JS-rendered SPAs via Playwright. $0.01 USDC per call on Base mainnet.
