...
- [WingmanProtocol Agent Gateway](https://agent.wingmanprotocol.com) - 15 deterministic construction & finance calculators for AI agents (mortgage, concrete, framing, contractor markup, draw schedules). x402 pay-per-call (USDC on Base, $0.001–$0.002) + 500 free calls/month with a key. Self-describing x402 manifest, MCP + REST + OpenAPI. ([MCP server](https://github.com/WingmanProtocol-Agent-Gateway/wingman-agent-gateway) | [manifest](https://agent.wingmanprotocol.com/.well-known/x402))
