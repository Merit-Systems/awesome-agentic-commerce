...
- [FillBench](https://fillbench.com/x402-payment-rails/) - Reproducible benchmarks of x402 settlement time by chain, measured from real on-chain payments (Algorand mainnet clocked ~5.2s median vs the ~2.8s block-time spec). Open methodology + raw data.
