...
- [BridgeNode](https://bridgenode.cc) - AI inference bridge for autonomous agents: OpenAI-compatible chat completions (DeepSeek, Groq), pay per request with **Solana USDC via x402**. No API keys, no registration, gasless (fee sponsorship), full refunds on provider failure. SDKs: [Python](https://github.com/applefanaimail-blip/bridgenode-sdk-python) / [TypeScript](https://github.com/applefanaimail-blip/bridgenode-sdk-ts) / [MCP](https://github.com/applefanaimail-blip/bridgenode-mcp). [Verified on x402-list](https://x402-list.com/services/bridgenode).
